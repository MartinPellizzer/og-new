...
pdf.cell(0, font_size//2, "MiNi O3", ln=True, align="C")
pdf.set_font("Arial", size=10)
...
pdf.image(f'ozonogroup-ozonizzatore-mini.png', w=100, x=190//2 - 100//2)
...
# Salvataggio
data_name = data['name']
data_slug = data_name.lower().strip().replace(' ', '-')
output_filepath = f'{data_slug}-scheda-tecnica.pdf'
