...
void nextion_input_p_password()
{
  if (nextion_array_compare(cmd_p_password_ok, nextion.inputs_buff)) 
  {
    ...
    if (valid_password)
    {
      nextion.page_cur = P_SET_OPERATOR;
...
void nextion_input_p_set_operator()
{
...
{
  if (nextion_array_compare(cmd_p_calendar_back, nextion.inputs_buff)) nextion.page_cur = P_SET_OPERATOR;
...
{
  if (nextion_array_compare(cmd_p_clock_back, nextion.inputs_buff)) nextion.page_cur = P_SET_OPERATOR;
...
void nextion_eval_serial() 
{
  ...
  else if (nextion.page_cur == P_SET_OPERATOR)      nextion_input_p_set_operator();
...
void nextion_update() 
{
  ...
  else if (nextion.page_cur == P_SET_OPERATOR)      nextion_update_page_set_operator(force_refresh);
...
void nextion_update_page_set_operator(uint8_t force_refresh) 
{
  if (force_refresh) 
  {
