...
def home_benefits():
    ...
    '''
    html_card_1 = components.card_default_1(
        ...
        title = components.h3_default(
            text = f'''
                Rispetta gli standard HACCP per la sicurezza alimentare
            ''',
        ),
        ...
        ''',
        link = f'''
            <a style="color: #3E546A; text-decoration-line: none;" href="#">
                Learn more
            </a>
        ''',
    )
    html_card_2 = components.card_default_1(
        suptitle = components.suptitle_default(
            text = f'''
                02 - Efficacia
            ''',
        ...
        title = components.h3_default(
            text = f'''
                Efficace su batteri, virus, muffe, odori e altri microrganismi
            ''',
        ),
        paragraph = components.paragraph_default(
            text = f'''
    ...
    html_card_3 = components.card_default_1(
        suptitle = components.suptitle_default(
            text = f'''
                03 - Sostenibilità
            ''',
        ...
        title = components.h3_default(
            text = f'''
                Sanifica in modo ecologico, senza uso di sostanze chimiche
            ''',
        ),
        paragraph = components.paragraph_default(
            text = f'''
...
def home_services():
    ...
    html_card_1 = components.card_default(
        ...
        paragraph = components.paragraph_default(text="Analizziamo il tuo ambiente produttivo, i rischi biologici specifici e le necessita operative per proporre una soluzione su misura basata sull'ozono.",)
    )
    html_card_2 = components.card_default(
        ...
        paragraph = components.paragraph_default(text="Sviluppiamo una soluzione su misura, combinando le migliori tecnologie a ozono con un design personalizzato per otimizzare igiene, efficienza e sostenibilita.",),
    )
    html_card_3 = components.card_default(
        ...
        paragraph = components.paragraph_default(text="Il nostro team tecnico si occupa dell'installazione e forma il tuo personale sull'utilizzo sicuro e ottimale del sistema.",),
    )
    html_card_4 = components.card_default(
        ...
        paragraph = components.paragraph_default(text="Forniamo supporto tecnico continuo e piano di manutenzione preventiva per assicurare performance costanti e conformita normativa nel tempo.",),
    )
    html_cards = f'''
...
def home_sectors():
    html_h2_default = components.h2_default(
        text = f'''
            Soluzioni specifiche per ogni filiera alimentare
        ''',
    )
    html_paragraph_1 = components.paragraph_default(
        text = f'''
            Ogni settore dell'industria alimentare ha esigenze diverse in termini di igiene, normativa e tipo di contaminazione microbiologica.
        '''
    )
    html_paragraph_2 = components.paragraph_default(
        text = f'''
            I sistemi di sanificazione all'ozono di Ozonogroup sono progettati per adattarsi perfettamente a questi contesti, garantendo efficacia microbiologica, sostenibilità ambientale e conformità normativa.
        '''
    )
    html_header = f'''
        <div class="home-services-intro-container">
    ...
    html_card_1 = components.card_default_1(
        ...
        paragraph = components.paragraph_default(
            text = f'''
                Sanificazione profonda in ambienti ad alto rischio microbiologico. Eliminazione di patogeni come Salmonella, Listeria e E. coli da superfici, macchinari e ambienti. Sistemi integrati nelle linee di disosso, sezionamento e confezionamento. Controllo degli odori e prevenzione della formazione di biofilm.
            ''',
        ),
        icon = f'''
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f">
        ...
        ''',
        link = f'''
            <a style="color: #3E546A; text-decoration-line: none;" href="/settori.html">
                Scopri Settori
            </a>
        ''',
    )
    html_card_2 = components.card_default_1(
        ...
        paragraph = components.paragraph_default(
            text = f'''
                Igiene in ambienti umidi, a bassa temperatura e ad alto carico organico. Ozono efficace anche in ambienti freddi (5°C), ideale per celle e zone di lavorazione pesce. Riduzione della carica batterica su filetti, crostacei, superfici e nastri trasportatori. Prolungamento della shelf-life senza additivi chimici.
            ''',
        ),
        icon = f'''
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f">
    ...
    html_card_3 = components.card_default_1(
        ...
        paragraph = components.paragraph_default(
            text = f'''
                Sanificazione post-raccolta, durante lo stoccaggio e nel confezionamento. Rimozione di muffe e lieviti (Botrytis, Penicillium) responsabili del deterioramento precoce. Disinfezione di casse, nastri, vasche di lavaggio e aria nelle aree di confezionamento.
            ''',
        ),
        icon = f'''
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f">
    ...
    html_card_4 = components.card_default_1(
        suptitle = components.suptitle_default(
            text = f'''
                04
            ''',
        ...
        paragraph = components.paragraph_default(
            text = f'''
                Controllo microbiologico in ambienti sensibili alla contaminazione crociata. Rimozione di Listeria monocytogenes in vasche, superfici e impianti CIP. Disinfezione di aria e superfici nelle aree di fermentazione e maturazione. Sistemi compatibili con ambienti ad alta umidità e carico proteico.
            ''',
        ),
        icon = f'''
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f">
    ...
    html_card_5 = components.card_default_1(
        suptitle = components.suptitle_default(
            text = f'''
                05
            ''',
        ...
        title = components.h3_default(
            text = f'''
                 Bevande e Imbottigliamento
            ''',
        ),
        paragraph = components.paragraph_default(
            text = f'''
                Igienizzazione delle linee e prevenzione di alterazioni microbiologiche nei liquidi. Ozono in forma gassosa e acquosa per la sanificazione di serbatoi, tubazioni, riempitrici. Sistemi integrati nei processi CIP e SIP. Nessun residuo chimico: ideale per produzione biologica o senza conservanti.
            ''',
        ),
        icon = f'''
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f">
