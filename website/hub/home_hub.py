...
def gen():
    ...
    ozono = f'''
        <section class="container-xl" style="padding-top: {section_py}; padding-bottom: {section_py};">
            ...
            <div class="grid-2" style="column-gap: 3rem; row-gap: 0;">
                <div>
                    ...
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 2rem;">
                        ...
                        <div style="display: inline-block;">
                            <a class="button-default-2" href="/prodotti.html">
                                <span>Vedi Articoli</span>
                                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/></svg>                
                            </a>
                        </div>
                    </div>
                    <img style="border-radius: 1rem; height: 40rem; object-fit: cover;" src="{data[2]['image_src']}">
                </div>
                <div style="display: flex;">
                    <div>
                        <h3 style="color: #222222; font-size: 2rem; line-height: 1.1; font-weight: bold; margin-bottom: 2rem;">
                            {data[0]['title']}
                        </h3> 
                        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 2rem;">
                    ...
                    <img style="border-radius: 1rem; height: 10rem; object-fit: cover;" src="{data[0]['image_src']}">
                </div>
            <div>
        </section>
        <div style="background-color: #ededed; height: 1px;"></div>  
