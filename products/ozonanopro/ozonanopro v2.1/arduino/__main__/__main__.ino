...
typedef struct cycle_t {
  ...
  int8_t state_o2_ncno_old = -2;
  int8_t state_o2_ncno_tmp = -1;
  int8_t state_o2_ncno_cur = 0;

  int8_t state_o3_old = -2;
  int8_t state_o3_tmp = -1;
  int8_t state_o3_cur = 0;
  int8_t state_o3_ncno_old = -2;
  int8_t state_o3_ncno_tmp = -1;
  int8_t state_o3_ncno_cur = 0;

  int8_t state_so_old = -2;
  int8_t state_so_tmp = -1;
  int8_t state_so_cur = 0;
  int8_t state_so_ncno_old = -2;
  int8_t state_so_ncno_tmp = -1;
  int8_t state_so_ncno_cur = 0;
