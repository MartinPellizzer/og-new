...
void nextion_eval_serial() 
{
  ...
  {
    // if (nextion_array_compare(cmd_p_analytics_back, nextion.inputs_buff)) nextion.page_cur = 1;
  }
}
...
void nextion_update() 
{
  ...
  else if (nextion.page_cur == 40) nextion_update_page_analytics(force_refresh);
