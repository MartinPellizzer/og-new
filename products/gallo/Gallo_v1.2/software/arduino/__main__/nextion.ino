...
void nextion_eval_page_home() 
{
  if (is_on_cur == 0)
  {
    if (nextion_array_compare(cmd_p_home_goto_settings, nextion.inputs_buff)) nextion.page_cur = 100;
  }
...
void nextion_eval_serial() 
{
  ...
  else if (nextion.page_cur == 11) 
  {
    ...
    {
      power.power_tmp += 1;
      if (power.power_tmp > 3) power.power_tmp = 3;
    }
    if (nextion_array_compare(cmd_p_power_down, nextion.inputs_buff)) 
    {
      power.power_tmp -= 1;
      if (power.power_tmp < 1) power.power_tmp = 1;
    }
  } 
...
void nextion_update() 
{
  ...
  else if (nextion.page_cur == 100) nextion_update_page_password(force_refresh);
  else if (nextion.page_cur == 110) nextion_update_page_sensor_temperature(force_refresh);
